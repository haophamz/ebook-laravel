...
<div class="page-head">
    <div>
        ...
        <p>Chỉnh sửa thông tin coupon.</p>
    </div>
</div>
...
<form action="{{ route('admin.coupons.update',$coupon) }}" method="POST">
    ...
    <div class="card-body">
        ...
        <div class="field">
            <label id="value_label">Giá trị</label>
        ...
        <div class="field">
            ...
            <input
                ...
                name="started_at"
                class="form-control"
                value="{{ old('started_at', optional($coupon->started_at)->format('Y-m-d\TH:i')) }}">
        </div>
        ...
        <div class="field">
            ...
            <input
                ...
                name="expired_at"
                class="form-control"
                value="{{ old('expired_at', optional($coupon->expired_at)->format('Y-m-d\TH:i')) }}">
        </div>
